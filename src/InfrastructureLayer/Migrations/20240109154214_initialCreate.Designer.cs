...
namespace InfrastructureLayer.Migrations
{
    ...
    [Migration("20240109154214_initialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DomainLayer.AggregatesModel.PersonneAggregate.Personne", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DomainLayer.AggregatesModel.PersonneAggregate.Souscripteur", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DomainLayer.AggregatesModel.ContratAutoAggregate.ContratAuto", b =>
                {
                    b.HasOne("DomainLayer.AggregatesModel.PersonneAggregate.Souscripteur", "Souscripteur")
                        .WithMany()
            ...
            modelBuilder.Entity("DomainLayer.AggregatesModel.PersonneAggregate.Personne", b =>
                {
                    b.HasOne("DomainLayer.AggregatesModel.PersonneAggregate.Souscripteur", null)
                        .WithMany("Enfants")
                        .HasForeignKey("SouscripteurId");

                    b.OwnsOne("DomainLayer.AggregatesModel.PersonneAggregate.Adresse", "Adresse", b1 =>
                        {
            ...
            modelBuilder.Entity("DomainLayer.AggregatesModel.PersonneAggregate.Souscripteur", b =>
                {
                    b.HasOne("DomainLayer.AggregatesModel.PersonneAggregate.Personne", "Conjoint")
                        .WithMany()
